...
public class FeedBackActivity extends com.huiche.lib.lib.base.BaseActivity {
    ...
    private void saveFeedBack() {
        ...
        if (!IsMobileNumber.isMobileNO(feedBackContact)) {
            T("请输入正确的手机号码");
            return;
        }
        ...
        sb.append("{").append("\"us_id\":\"").append(MyApplication.loginResultBean.data.id).append("\",\"su_title\":\"").append(tv_content.getText().toString().trim()).append("\",\"su_content\":\"").append(feedBackMsg).append("\",\"su_mobile\":\"").append(feedBackContact).append("\"}");
