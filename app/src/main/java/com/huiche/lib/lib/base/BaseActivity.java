...
public abstract class BaseActivity extends FragmentActivity implements View.OnClickListener {
    ...
    /*******************************************/
    //设置左边默认图片
    protected static final int leftDrawable = R.drawable.back_arrow_left;
    //设置右边默认图片
...
//        tv_left.setPadding(dip2px(this, 30), dip2px(this, 30), dip2px(this, 30), dip2px(this, 30));
...
//            tv_left.setCompoundDrawables(null, drawableRight, null, null);//只放上边
    ...
    public void setRightRes(int resId) {
        if (null != tv_right) {
            Drawable drawableRight = ContextCompat.getDrawable(this, resId);
            assert drawableRight != null;
            drawableRight.setBounds(0, 0, dip2px(contextAppliction, 20), dip2px(contextAppliction, 20));//第一0是距左边距离，第二0是距上边距离，40分别是长宽
            tv_right.setCompoundDrawables(null, drawableRight, null, null);//只放上边
        }
    }
