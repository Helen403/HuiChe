...
import com.huiche.service.CoreService;
...
public final class MainActivity extends FragmentActivity implements RadioGroup.OnCheckedChangeListener {
     ...
     * 需要配置的东西
     */
    private Fragment[] fragments = {new HomeFragment(), new IntegralShopFragment(), new U_CardFragment(), new ShoppingCartFragment(), new MineFragment()};
    private String titles[] = {"首页", "积分商城", " ", "扫一扫", "我的"};
    private int[] bg_normal = {R.drawable.home_page_hui, R.drawable.integral_mall, R.drawable.sou_00, R.drawable.scan_gr, R.drawable.personal_center_gr};
    private int[] bg_pressed = {R.drawable.home_page, R.drawable.integral_mall_hui, R.drawable.sou_00, R.drawable.scan, R.drawable.personal_center};
    ...
    /*******************************************/
    //设置左边默认图片
    private static final int leftDrawable = R.drawable.back_arrow_left;
    //设置右边默认图片
