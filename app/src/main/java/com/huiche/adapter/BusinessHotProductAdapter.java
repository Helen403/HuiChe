 ...
 */
public class BusinessHotProductAdapter extends ListBaseAdapter {
    ...
    public BusinessHotProductAdapter(Context context, boolean isProductDetail) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ImagLoadUtils.setImage(info.goodsImgs.get(0), mHolder.icon, mContext);
        mHolder.productName.setText(info.name);
        mHolder.memberPrice.setText("￥" + info.realPrice);
