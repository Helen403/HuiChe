 ...
 * 
 */
public class AdapterGridView_CitySelect_NearByFragment extends
	...
	public AdapterGridView_CitySelect_NearByFragment(Context context, List<String> list,GridViewFromNearByListener activity) {
		super(context, list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position == selectPositon) {
				holder.cityNames.setBackground(mContext.getResources().getDrawable(R.color.selected));
		}else{
			holder.cityNames.setBackground(mContext.getResources().getDrawable(R.color.white));
		}
