...
public class OnLineHasCloseAdapter extends BaseAdapter{
	
	private List<OnLineUnSendInfo>dataList=new ArrayList<OnLineUnSendInfo>();
	private Context mContext;
	public OnLineHasCloseAdapter(Context mContext,List<OnLineUnSendInfo>dataList){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView==null){
			convertView=LayoutInflater.from(mContext).inflate(R.layout.item_has_close, null);
			holder=new Holder();
