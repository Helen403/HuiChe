...
public class IntegralOutComeAdapter extends BaseAdapter {
    private Context mContext;
    private List<IntegralInComeInfo> dataList = new ArrayList<IntegralInComeInfo>();

    public IntegralOutComeAdapter(Context mContext,
                                  List<IntegralInComeInfo> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.item_integral_out, null);
            holder = new ViewHolder();
            holder.tv_integral = (TextView) convertView
                    .findViewById(R.id.money_integral);
            holder.tv_content = (TextView) convertView
                    .findViewById(R.id.tv_why);
