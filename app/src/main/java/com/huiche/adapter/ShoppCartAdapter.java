...
//    private int location = 0;
    ...
    public ShoppCartAdapter(Context context, List<BusinessStoreList> groupList, Map<Integer, List<ShoppingCartProductInfo>> childList) {
...
//        share = context.getSharedPreferences("user_data", context.MODE_PRIVATE);
    ...
    public ViewHolderGroup viewHolderGroup = null;
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        holderChild.doorPrice.setText("市场价:" + childList.get(groupList.get(groupPosition).getId()).get(childPosition).getProductP().getMarketPrice() + "元");
        ...
        double tmp = childList.get(groupList.get(groupPosition).getId()).get(childPosition).getProductP().getIntegral();


        holderChild.exchangeIntegral.setText(df.format(tmp) + "积分");
        /********************************************************************/
        ...
        //测试闪屏
//        holderChild.productIcon.setImageResource(R.drawable.ic_launcher);
