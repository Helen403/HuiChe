...
public class LineUnPayADetaildapter extends BaseAdapter {
    private List<LineUnPayDetail> dataList = new ArrayList<LineUnPayDetail>();
    private Context mContext;

    public LineUnPayADetaildapter(Context context, List<LineUnPayDetail> dataList) {
