...
public class OnLineAllOrderProductAdapter extends BaseAdapter{
	private Context mContext;
	private List<OnLineAllOrderDetail>dataList=new ArrayList<OnLineAllOrderDetail>();
	public OnLineAllOrderProductAdapter(Context mContext,List<OnLineAllOrderDetail>dataList){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String path=dataList.get(position).images[0];
