...
import com.huiche.R;
import com.huiche.adapter.HasFragmentAdapter;
...
public class HasFragment extends BaseFragment {
    ...
    private int indexPage = 1, page = 1, rows = 10, status = 4;
    ...
    private HasFragmentAdapter adapter;

    @Override
    public View inflateView(LayoutInflater inflater, ViewGroup container,
                            Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_has_fragment, container, false);
        return view;
    }
    ...
    public void initData() {
        adapter = new HasFragmentAdapter(getActivity(), alldata);
