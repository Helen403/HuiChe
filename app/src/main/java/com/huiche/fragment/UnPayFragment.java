...
import com.huiche.R;
import com.huiche.adapter.OnLineUnPayAdapter;
...
public class UnPayFragment extends BaseFragment {
    ...
    private OnLineUnPayAdapter adapter;
//	private int count=0;
    ...
    public void findViews() {
        pull_list = (PullToRefreshListView) view.findViewById(R.id.order_listview);
    ...
    public void initData() {
        adapter = new OnLineUnPayAdapter(getActivity(), alldata);
