...
import com.huiche.R;
import com.huiche.adapter.OnLineUnCancelAdapter;
...
public class HasCancelFragment extends BaseFragment {
    private View view;
    ...
    private int indexPage = 1, page = 1, rows = 10, status = 2;
    ...
    private OnLineUnCancelAdapter adapter;

    @Override
    public View inflateView(LayoutInflater inflater, ViewGroup container,
                            Bundle savedInstanceState) {

        view = inflater.inflate(R.layout.activity_unpay_fragment, container,
                false);
        return view;
    }
    ...
    public void initData() {
        adapter = new OnLineUnCancelAdapter(getActivity(), alldata);
        myListview.setAdapter(adapter);
        getHasCancelData();

    }

    private void getHasCancelData() {
