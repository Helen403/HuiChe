...
import com.huiche.R;
import com.huiche.adapter.OnLineHasCloseAdapter;
...
public class HasCloseFragment extends BaseFragment {
    private View view;
    ...
    private int indexPage = 1, page = 1, rows = 10, status = 3;
    ...
    private OnLineHasCloseAdapter adapter;

    @Override
    public View inflateView(LayoutInflater inflater, ViewGroup container,
                            Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_unpay_fragment, container, false);
        return view;
    }
    ...
    public void initData() {
        adapter = new OnLineHasCloseAdapter(getActivity(), alldata);
